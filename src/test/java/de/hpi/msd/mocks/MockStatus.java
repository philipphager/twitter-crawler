...
public class MockStatus implements Status {
    ...
    private final Status retweetStatus;

    public MockStatus(long tweetId, User user) {
        this.tweetId = tweetId;
        this.user = user;
        this.isRetweet = false;
        this.retweetStatus = null;
    }

    public MockStatus(long tweetId, User user, Status retweetStatus) {
        this.tweetId = tweetId;
        this.user = user;
        this.isRetweet = true;
